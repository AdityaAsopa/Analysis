...
class EvalFunc:
    ...
    def fitCell( self ):
        ...
        for ff in freqList:
            ...
            self.dumpFindSim( meanSTP, meanTpk, iff, True, False ) # for the peaks
            if self.doPairedPulse:
                self.dumpFindSim( meanSTP, meanTpk, iff, True, True ) # for the paired pulse
            if ( self.matchMinima ):
                self.dumpFindSim( meanSTP, meanTpk, iff, False, False ) # for the minima
        ...
        for ff in freqList:
            ...
            #print( "Removing Expts/fs_{}_{}_min.json".format( fileSig,iff))
    ...
    "Readouts": {{
        ...
        with open( fname, "w" ) as fp:
            ...
            #print( meanSTP )
            for idx, stp in enumerate( meanSTP ):
        ...
        for ff in freqList:
            ...
            if hasMin:
                exptStr +='{}"fs_{}_{}_min.json": {{"weight": {} }}'.format(
                    comma, fileSig, iff, 50 if iff in [20, 50] else 25 )
